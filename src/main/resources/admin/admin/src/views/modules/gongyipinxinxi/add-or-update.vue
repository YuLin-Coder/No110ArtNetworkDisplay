<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工艺品名称" prop="gongyipinmingcheng">
          <el-input v-model="ruleForm.gongyipinmingcheng" 
              placeholder="工艺品名称" clearable  :readonly="ro.gongyipinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工艺品名称" prop="gongyipinmingcheng">
              <el-input v-model="ruleForm.gongyipinmingcheng" 
                placeholder="工艺品名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="工艺品类型" prop="gongyipinleixing">
          <el-select :disabled="ro.gongyipinleixing" v-model="ruleForm.gongyipinleixing" placeholder="请选择工艺品类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="工艺品类型" prop="gongyipinleixing">
	      <el-input v-model="ruleForm.gongyipinleixing"
                placeholder="工艺品类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="制作人" prop="zhizuoren">
          <el-input v-model="ruleForm.zhizuoren" 
              placeholder="制作人" clearable  :readonly="ro.zhizuoren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="制作人" prop="zhizuoren">
              <el-input v-model="ruleForm.zhizuoren" 
                placeholder="制作人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	gongyipinmingcheng : false,
	gongyipinleixing : false,
	guige : false,
	caizhi : false,
	zhizuoren : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='gongyipinmingcheng'){
            this.ruleForm.gongyipinmingcheng = obj[o];
	    this.ro.gongyipinmingcheng = true;
            continue;
          }
          if(o=='gongyipinleixing'){
            this.ruleForm.gongyipinleixing = obj[o];
	    this.ro.gongyipinleixing = true;
            continue;
          }
          if(o=='guige'){
	    ...
	    this.ro.caizhi = true;
          ...
          if(o=='zhizuoren'){
            this.ruleForm.zhizuoren = obj[o];
	    this.ro.zhizuoren = true;
            continue;
          }
	...
	this.ruleForm.xiangqingmiaoshu = this.ruleForm.xiangqingmiaoshu.replace(reg,'../../../springbootq9413/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gongyipinxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gongyipinxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
